    ...
    protected void onDraw(@NonNull Canvas canvas) {
        ...
        if (b != null) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                bitmapDrawable = ((BitmapDrawable) getResources().getDrawable(R.drawable.default_image, null));
            }else{
                bitmapDrawable = ((BitmapDrawable) getResources().getDrawable(R.drawable.default_image));
            }
